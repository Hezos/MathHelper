...
export function MultiplicationPage(){
    ...
    return ( 
        ...
        <br></br>
        <p class="text-start h4" style={{fontFamily:"sans-serif"}}>  It is recommended to review addition first before starting this topic. </p>
        <br></br>
        ...
        <br></br>
        <p class="text-center h4" style={{color:"green"}} > 2 + 2 + 2 + 2 + 2 + 2 = 12 </p>
        ...
        <br></br>
        <p class="text-center h4" style={{color:"green",fontFamily:"sans-serif"}} > 6 &#8729; 2 = 12</p>
        <p class="text-start h4" style={{color:"green", fontFamily:"sans-serif"}}> 
        ...
        <br></br>
        <p class="text-center h4" style={{color:"green",fontFamily:"sans-serif"}}> 6 &#8729; 2 = 2 + 2 + 2 + 2 + 2 + 2 </p>
        <br></br>
        <p class="text-start h4" style={{fontFamily:"sans-serif"}}>
        ...
        <p class="text-center h4" style={{color:"green",fontFamily:"sans-serif"}} >3 &#8729; 5 = 15</p>
        <br></br>
        <p class="text-start h4" style={{fontFamily:"sans-serif"}}>
            <u>
