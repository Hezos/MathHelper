    ...
    return(
        <div>
            ...
            <div class="container border border-primary border-3 rounded-4 " style={{background:"darkgray"}}>
                ...
                <p class="h6 display-6 text-start" style={{fontFamily:"sans-serif"}}>
                ...
                <p class="h6 display-6 text-start" style={{fontFamily:"sans-serif", color:"blue"}}>
                ...
                <p class="h6 display-6 text-start" style={{fontFamily:"sans-serif", color:"green"}}>
                ...
                <p class="h6 display-6 text-start" style={{fontFamily:"sans-serif", color:"red"}}>
